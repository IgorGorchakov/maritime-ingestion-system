 ...
 * The gateway HTTP contract returns the full Avro-JSON of the enriched event. We
...
@Slf4j
@Repository
public class PostgresVesselStateStore implements VesselStateStore {

    private final JdbcTemplate jdbc;

    public PostgresVesselStateStore(JdbcTemplate jdbc) {
        this.jdbc = jdbc;
    }
