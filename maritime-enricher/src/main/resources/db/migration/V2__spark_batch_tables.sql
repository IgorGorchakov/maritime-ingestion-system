...
-- Created by Flyway (managed in maritime-enricher alongside V1__zones.sql).
-- These tables are written by the Spark jobs and read by the API service history endpoint.
...
-- Index on date alone: the API service history query filters on mmsi first (PK prefix
