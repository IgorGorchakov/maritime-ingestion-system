...
public class MaritimeTopology {
    ...
    Topology buildTopology() {
        ...
        builder.stream(INPUT_TOPIC,
                ...
                .process(detectionProcessor(), STATE_STORE)
    ...
    private ProcessorSupplier<String, EnrichedVesselEvent, String, EnrichedVesselEvent> detectionProcessor() {
                ...
                try (KeyValueIterator<String, VesselState> it = store.all()) {
                    while (it.hasNext()) {
                        ...
                        if (isDark && !wasDark) {
                            ...
                            // detection record so storage/api can surface it.
