...
public class VesselState {
    ...
    public boolean isDarkVessel() {
        return darkVessel;
    }

    public void setDarkVessel(boolean darkVessel) {
        this.darkVessel = darkVessel;
    }

    public boolean isSpeedAnomaly() {
        return speedAnomaly;
    }

    public void setSpeedAnomaly(boolean v) {
        this.speedAnomaly = v;
    }

    public Instant lastSeen() {
        return Instant.ofEpochMilli(lastSeenMs);
    }
